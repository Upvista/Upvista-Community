...
export function MediaViewer({
  ...
  const handleOpenFile = () => {
    if (!currentMessage.attachment_url) return;
    
    // Open file in new tab or supporting app
    window.open(currentMessage.attachment_url, '_blank', 'noopener,noreferrer');
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const response = await fetch(currentMessage.attachment_url);
    ...
    <div className="fixed inset-0 bg-black z-[100] flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="w-full h-full flex items-center justify-center p-4 md:p-8">
          {currentMessage.message_type === 'image' && currentMessage.attachment_url && (
            <div className="relative w-full h-full flex items-center justify-center">
              {/* High-Quality Image with Shadow */}
              <img
                src={currentMessage.attachment_url}
                alt="Media"
          ...
          {/* Video Player */}
          {currentMessage.message_type === 'video' && currentMessage.attachment_url && (
          ...
          {currentMessage.message_type === 'audio' && currentMessage.attachment_url && (
            <div className="w-full max-w-md">
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl shadow-2xl overflow-hidden border border-gray-700/50">
                ...
                <div className="p-6">
                  <AudioPlayer url={currentMessage.attachment_url} duration={0} />
                </div>
              </div>
            </div>
          )}
