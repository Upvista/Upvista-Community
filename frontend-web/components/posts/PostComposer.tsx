...
export default function PostComposer({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full h-full md:h-auto md:max-w-3xl md:max-h-[90vh] bg-white dark:bg-neutral-900 md:rounded-2xl shadow-2xl flex flex-col animate-scale-in">
        {/* Header */}
        ...
        {/* Tabs */}
        <div className="flex gap-2 px-6 py-4 border-b border-neutral-200 dark:border-neutral-800 overflow-x-auto">
          {tabs.map((tab) => {
            const Icon = tab.icon;
